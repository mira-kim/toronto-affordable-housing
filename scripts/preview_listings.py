...
Usage (from project root):
    python scripts/preview_listings.py          # active listings (default)
    python scripts/preview_listings.py empty    # no listings / empty state
"""
...
def main():
    ...
    if not os.path.exists(MAP_SRC):
        print(f"Map not found at {MAP_SRC}. Run scripts/map_toronto_housing.py first.")
        return
